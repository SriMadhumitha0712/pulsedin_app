...
class ColorResource {
  ...
  static const Color lightBlue = Color(0xff16BFFF);
  static const Color darkBlue = Color(0xff16DFFF);
  static const Color black = Colors.black;
  static const Color cardlightBlue = Color(0xffF5FFFF);
  static const Color ash = Color(0xff6C6C6C);
